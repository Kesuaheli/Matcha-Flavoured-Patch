...
execute as @a[gamemode=!creative] at @s if biome ~ ~ ~ #minecraft:is_frozen if block ~ ~1 ~ water unless predicate matcha:armour_enchants/freezing_protection run function matcha:environmental/freezing_water
