...
execute if score current_world_settings_difficulty difficulty_score matches 1 if score @s Hearts < minimum_hearts Hearts run scoreboard players set @s Hearts 20
...
execute unless score current_world_settings_difficulty difficulty_score matches 1 if score @s Hearts < current_minimum_hearts Hearts store result score @s Hearts run scoreboard players get current_minimum_hearts Hearts
